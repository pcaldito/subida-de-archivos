<?php
    ...
    if ($_SERVER['REQUEST_METHOD'] == 'POST') {
        ...
        $carpeta = 'archivos/';
        $extension = strtolower(pathinfo($nombreImagenOriginal, PATHINFO_EXTENSION));

        // Generar nombre de la imagen basado en el nombre del minijuego
        $nombreImagenFinal = $nombreJuego . '.' . $extension;
        $rutaFinal = $carpeta . $nombreImagenFinal;
        ...
        if (move_uploaded_file($rutaTemporal, $rutaFinal)) {
            ...
            $consulta = "UPDATE minijuegos SET imagen = '$nombreImagenFinal' WHERE nombre = '$nombreJuego'";
